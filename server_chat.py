...
if __name__ == "__main__":
    chat_host = input("Введите имя хоста для сервера чата (пустая строка для использования localhost): ") or 'localhost'
    chat_port = int(input("Введите номер порта для сервера чата: "))
